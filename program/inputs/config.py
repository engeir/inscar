...
Y_MAX_i = 1.5e-2
# When using real data, E_max = 600 eV -> 14.52e6 m/s
V_MAX = 3e7
ORDER = 3
...
I_P = {'B': 35000e-9, 'F0': 430e6, 'F_MAX': 8e6, 'MI': 29, 'NE': 2e10,
       'NU_E': 0, 'NU_I': 0, 'T_E': 200, 'T_I': 200, 'T_ES': 10000, 'THETA': 45 * np.pi / 180}
...
# I_P = {'B': 5e-4, 'F0': 430e6, 'F_MAX': 2e7, 'MI': 16, 'NE': 2e10, 'NU_E': 1000, 'NU_I': 0,
